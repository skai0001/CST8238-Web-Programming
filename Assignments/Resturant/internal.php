...
if (! (isset ( $_SESSION ["username"] )) || ! (isset ( $_SESSION ["password"] ))) {
	...
	echo "<script type='text/javascript'>window.top.location='http://skai0001.algonquincollege.club/CST8238/Assignment3/Resturant/login.php';</script>";
	exit ();
}

$sql = "SELECT * FROM adminusers;";
$result = mysqli_query ( $connection, $sql );
echo '<h3 style="color:red;"> Welcome to the admin page , This is a restricted area!!</h3>';
