...
<div id="content" class="clearfix">
	...
	<div class="main">
		<h1>Welcome to Skaiky's Diner!</h1>
       ...
       <?php
            $event1 = new EventItem("St. Patty's Day Party","Tuesday March 17, 2017","Join us for an authentic Irish four course meal, complete with shepard's pie and one green beer!","$35.00"); //Step 4
        ...
        <p>
        <?php
         $event2 = new EventItem("Samy's Spring Fling!","Saturday April 18, 2017","Join us for to kick off the beginning of spring! This event will include 4 of Samy's infamous appetizers and one cocktail!","$40.00"); //Step 4
